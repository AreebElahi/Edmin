            ...
            <AdminPageWrapper>
                <AdminPageHeader
                    ...
                    actions={
                        <div className="relative group">
                            ...
                            >
                                <Lock className="w-3.5 h-3.5" /> Process Payroll (Coming Soon)
                            </button>
                ...
                {isLoading ? (
                    ...
                    <div className="bg-surface rounded-[2px] p-16 text-center border border-border shadow-none">
                        ...
                        <p className="text-text-muted text-xs mt-1">Verify finance dashboard database records.</p>
                    </div>
                ) : (
                ...
                {isLoading ? (
                    ...
                    <div className="p-6 space-y-6 overflow-y-auto flex-1 text-text-primary">
                        ...
                        <div className="grid grid-cols-2 gap-4 bg-surface-hover rounded-[2px] p-4 border border-border text-xs">
                            ...
                            {details.leavesCount !== undefined && (
                                <div>
                                    <p className="text-text-muted font-bold uppercase text-[9px]">Approved Leaves</p>
                                    <p className="font-semibold text-error-text mt-0.5">{details.leavesCount} Days</p>
                                </div>
                            )}
                            {details.reportsCount !== undefined && (
                                <div>
                                    <p className="text-text-muted font-bold uppercase text-[9px]">Approved Reports</p>
                                    <p className="font-semibold text-success-text mt-0.5">{details.reportsCount} Days</p>
                                </div>
                            )}
                        </div>
